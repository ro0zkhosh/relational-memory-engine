# Runtime Tcl commands to interact with - RelationalCache_v1_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/RelationalCache_v1_0_include.tcl
...
# Test: Config_AXI
# Create a burst write transaction at config_axi_addr address
create_hw_axi_txn w_config_axi_addr [get_hw_axis $jtag_axi_master] -type write -address $config_axi_addr -len 4 -data $wdata_2 -burst INCR
# Create a burst read transaction at config_axi_addr address
create_hw_axi_txn r_config_axi_addr [get_hw_axis $jtag_axi_master] -type read -address $config_axi_addr -len 4 -burst INCR
# Initiate transactions
run_hw_axi r_config_axi_addr
run_hw_axi w_config_axi_addr
run_hw_axi r_config_axi_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_config_axi_addr]]
# Compare read data
if { $rdata_tmp == $wdata_2 } {
	puts "Data comparison test pass for - Config_AXI"
} else {
	puts "Data comparison test fail for - Config_AXI, expected-$wdata_2 actual-$rdata_tmp"
	inc ec
}
