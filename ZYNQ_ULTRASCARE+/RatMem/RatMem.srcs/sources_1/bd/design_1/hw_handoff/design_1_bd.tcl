...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net fetch_unit_2_M00_AXI [get_bd_intf_pins fetch_unit_0/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP0_FPD]
connect_bd_intf_net -intf_net [get_bd_intf_nets fetch_unit_2_M00_AXI] [get_bd_intf_pins fetch_unit_0/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets fetch_unit_2_M00_AXI]
  connect_bd_intf_net -intf_net fetch_unit_2_M01_AXI [get_bd_intf_pins fetch_unit_0/M01_AXI] [get_bd_intf_pins smartconnect_0/S00_AXI]
connect_bd_intf_net -intf_net [get_bd_intf_nets fetch_unit_2_M01_AXI] [get_bd_intf_pins fetch_unit_0/M01_AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets fetch_unit_2_M01_AXI]
  ...
  connect_bd_net -net fetch_unit_0_m00_axi_error [get_bd_pins fetch_unit_0/m00_axi_error] [get_bd_pins vio_0/probe_in3]
  connect_bd_net -net fetch_unit_0_m00_axi_txn_done [get_bd_pins fetch_unit_0/m00_axi_txn_done] [get_bd_pins vio_0/probe_in2]
  connect_bd_net -net fetch_unit_0_m01_axi_error [get_bd_pins fetch_unit_0/m01_axi_error] [get_bd_pins vio_0/probe_in1]
  connect_bd_net -net fetch_unit_0_m01_axi_txn_done [get_bd_pins fetch_unit_0/m01_axi_txn_done] [get_bd_pins vio_0/probe_in0]
  connect_bd_net -net fetch_unit_0_o_en_debug [get_bd_pins fetch_unit_0/o_en_debug] [get_bd_pins system_ila_3/probe0] [get_bd_pins vio_0/probe_in6]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets fetch_unit_0_o_en_debug]
  connect_bd_net -net fetch_unit_2_r_data [get_bd_pins fetch_unit_0/r_data] [get_bd_pins system_ila_1/probe0] [get_bd_pins vio_0/probe_in4]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets fetch_unit_2_r_data]
  connect_bd_net -net fetch_unit_2_w_spm_filtered_data [get_bd_pins fetch_unit_0/w_spm_filtered_data] [get_bd_pins system_ila_2/probe0] [get_bd_pins vio_0/probe_in5]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets fetch_unit_2_w_spm_filtered_data]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins fetch_unit_0/m00_axi_aresetn] [get_bd_pins fetch_unit_0/m01_axi_aresetn] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins fetch_unit_0/r_addr] [get_bd_pins vio_0/probe_out0]
  connect_bd_net -net vio_0_probe_out1 [get_bd_pins fetch_unit_0/r_size] [get_bd_pins vio_0/probe_out1]
  connect_bd_net -net vio_0_probe_out2 [get_bd_pins fetch_unit_0/en] [get_bd_pins vio_0/probe_out2]
  connect_bd_net -net vio_0_probe_out3 [get_bd_pins fetch_unit_0/r_start] [get_bd_pins vio_0/probe_out3]
  connect_bd_net -net vio_0_probe_out4 [get_bd_pins fetch_unit_0/r_end] [get_bd_pins vio_0/probe_out4]
  connect_bd_net -net vio_0_probe_out5 [get_bd_pins fetch_unit_0/w_addr] [get_bd_pins vio_0/probe_out5]
  connect_bd_net -net vio_0_probe_out6 [get_bd_pins vio_0/probe_out6]
  connect_bd_net -net vio_0_probe_out7 [get_bd_pins fetch_unit_0/m01_axi_init_axi_txn] [get_bd_pins vio_0/probe_out7]
  connect_bd_net -net vio_0_probe_out8 [get_bd_pins fetch_unit_0/m00_axi_init_axi_txn] [get_bd_pins vio_0/probe_out8]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins fetch_unit_0/m00_axi_aclk] [get_bd_pins fetch_unit_0/m01_axi_aclk] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins system_ila_0/clk] [get_bd_pins system_ila_1/clk] [get_bd_pins system_ila_2/clk] [get_bd_pins system_ila_3/clk] [get_bd_pins vio_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins rst_ps8_0_99M/ext_reset_in] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]

  # Create address segments
  create_bd_addr_seg -range 0x00004000 -offset 0xA0000000 [get_bd_addr_spaces fetch_unit_0/M01_AXI] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces fetch_unit_0/M00_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x00004000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
