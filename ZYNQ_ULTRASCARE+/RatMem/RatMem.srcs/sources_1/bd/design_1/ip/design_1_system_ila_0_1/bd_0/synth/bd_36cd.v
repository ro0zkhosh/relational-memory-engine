...
module bd_36cd
   (SLOT_0_AXI_araddr,
    ...
    clk,
    resetn);
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_0_AXI, ADDR_WIDTH 32, ARUSER_WIDTH 1, AWUSER_WIDTH 1, BUSER_WIDTH 1, CLK_DOMAIN design_1_zynq_ultra_ps_e_0_1_pl_clk0, DATA_WIDTH 128, FREQ_HZ 99990000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 1, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 16, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 16, NUM_WRITE_THREADS 1, PHASE 0.000, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 1, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 1" *) input [31:0]SLOT_0_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_1_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_1_AXI, ADDR_WIDTH 32, ARUSER_WIDTH 1, AWUSER_WIDTH 1, BUSER_WIDTH 1, CLK_DOMAIN design_1_zynq_ultra_ps_e_0_1_pl_clk0, DATA_WIDTH 128, FREQ_HZ 99990000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 1, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 2, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 2, NUM_WRITE_THREADS 1, PHASE 0.000, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 1, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 1" *) input [31:0]SLOT_1_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI:SLOT_1_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN design_1_zynq_ultra_ps_e_0_1_pl_clk0, FREQ_HZ 99990000, PHASE 0.000" *) input clk;
  ...
  bd_36cd_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe30(net_slot_0_axi_ruser),
        .probe31(net_slot_0_axi_wdata),
        .probe32(net_slot_0_axi_wstrb),
        .probe33(net_slot_0_axi_wuser),
        ...
        .probe39(net_slot_1_axi_ar_cnt),
        .probe4(net_slot_0_axi_arid),
        .probe40(net_slot_1_axi_araddr),
        .probe41(net_slot_1_axi_arburst),
        .probe42(net_slot_1_axi_arcache),
        .probe43(net_slot_1_axi_arid),
        .probe44(net_slot_1_axi_arlen),
        .probe45(net_slot_1_axi_arlock),
        .probe46(net_slot_1_axi_arprot),
        .probe47(net_slot_1_axi_arqos),
        .probe48(net_slot_1_axi_arsize),
        .probe49(net_slot_1_axi_aruser),
        ...
        .probe60(net_slot_1_axi_awuser),
        .probe61(net_slot_1_axi_b_cnt),
        .probe62(net_slot_1_axi_bid),
        .probe63(net_slot_1_axi_bresp),
        .probe64(net_slot_1_axi_buser),
        .probe65(net_slot_1_axi_r_cnt),
        .probe66(net_slot_1_axi_rdata),
        .probe67(net_slot_1_axi_rid),
        .probe68(net_slot_1_axi_rresp),
        .probe69(net_slot_1_axi_ruser),
        .probe7(net_slot_0_axi_arprot),
        .probe70(net_slot_1_axi_wdata),
        .probe71(net_slot_1_axi_wstrb),
        .probe72(net_slot_1_axi_wuser),
        .probe73(net_slot_1_axi_aw_ctrl),
        .probe74(net_slot_1_axi_w_ctrl),
        .probe75(net_slot_1_axi_b_ctrl),
        .probe76(net_slot_1_axi_ar_ctrl),
        .probe77(net_slot_1_axi_r_ctrl),
