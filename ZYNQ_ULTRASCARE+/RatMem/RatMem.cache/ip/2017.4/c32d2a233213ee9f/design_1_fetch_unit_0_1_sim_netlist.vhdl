...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_writer_v1_0_M00_AXI is
  ...
  signal \^m01_axi_awaddr\ : STD_LOGIC_VECTOR ( 26 downto 0 );
...
begin
  m01_axi_awaddr(26 downto 0) <= \^m01_axi_awaddr\(26 downto 0);
...
M_AXI_AWADDR_carry: unisim.vcomponents.CARRY8
     port map (
      ...
      O(2 downto 0) => \^m01_axi_awaddr\(26 downto 24),
...
\axi_awaddr[28]_i_10\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8808"
    )
        port map (
      I0 => \^m01_axi_awaddr\(16),
      I1 => m01_axi_aresetn,
      I2 => init_txn_ff,
      I3 => init_txn_ff2,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^m01_axi_awaddr\ : STD_LOGIC_VECTOR ( 31 downto 5 );
...
begin
  ...
  m01_axi_awaddr(31 downto 5) <= \^m01_axi_awaddr\(31 downto 5);
  ...
  o_en_debug <= 'Z';
  w_spm_filtered_data(0) <= 'Z';
  w_spm_filtered_data(1) <= 'Z';
  w_spm_filtered_data(2) <= 'Z';
  w_spm_filtered_data(3) <= 'Z';
  w_spm_filtered_data(4) <= 'Z';
  w_spm_filtered_data(5) <= 'Z';
  w_spm_filtered_data(6) <= 'Z';
  w_spm_filtered_data(7) <= 'Z';
  w_spm_filtered_data(8) <= 'Z';
  w_spm_filtered_data(9) <= 'Z';
  w_spm_filtered_data(10) <= 'Z';
  w_spm_filtered_data(11) <= 'Z';
  w_spm_filtered_data(12) <= 'Z';
  w_spm_filtered_data(13) <= 'Z';
  w_spm_filtered_data(14) <= 'Z';
  w_spm_filtered_data(15) <= 'Z';
  w_spm_filtered_data(16) <= 'Z';
  w_spm_filtered_data(17) <= 'Z';
  w_spm_filtered_data(18) <= 'Z';
  w_spm_filtered_data(19) <= 'Z';
  w_spm_filtered_data(20) <= 'Z';
  w_spm_filtered_data(21) <= 'Z';
  w_spm_filtered_data(22) <= 'Z';
  w_spm_filtered_data(23) <= 'Z';
  w_spm_filtered_data(24) <= 'Z';
  w_spm_filtered_data(25) <= 'Z';
  w_spm_filtered_data(26) <= 'Z';
  w_spm_filtered_data(27) <= 'Z';
  w_spm_filtered_data(28) <= 'Z';
  w_spm_filtered_data(29) <= 'Z';
  w_spm_filtered_data(30) <= 'Z';
  w_spm_filtered_data(31) <= 'Z';
  w_spm_filtered_data(32) <= 'Z';
  w_spm_filtered_data(33) <= 'Z';
  w_spm_filtered_data(34) <= 'Z';
  w_spm_filtered_data(35) <= 'Z';
  w_spm_filtered_data(36) <= 'Z';
  w_spm_filtered_data(37) <= 'Z';
  w_spm_filtered_data(38) <= 'Z';
  w_spm_filtered_data(39) <= 'Z';
  w_spm_filtered_data(40) <= 'Z';
  w_spm_filtered_data(41) <= 'Z';
  w_spm_filtered_data(42) <= 'Z';
  w_spm_filtered_data(43) <= 'Z';
  w_spm_filtered_data(44) <= 'Z';
  w_spm_filtered_data(45) <= 'Z';
  w_spm_filtered_data(46) <= 'Z';
  w_spm_filtered_data(47) <= 'Z';
  w_spm_filtered_data(48) <= 'Z';
  w_spm_filtered_data(49) <= 'Z';
  w_spm_filtered_data(50) <= 'Z';
  w_spm_filtered_data(51) <= 'Z';
  w_spm_filtered_data(52) <= 'Z';
  w_spm_filtered_data(53) <= 'Z';
  w_spm_filtered_data(54) <= 'Z';
  w_spm_filtered_data(55) <= 'Z';
  w_spm_filtered_data(56) <= 'Z';
  w_spm_filtered_data(57) <= 'Z';
  w_spm_filtered_data(58) <= 'Z';
  w_spm_filtered_data(59) <= 'Z';
  w_spm_filtered_data(60) <= 'Z';
  w_spm_filtered_data(61) <= 'Z';
  w_spm_filtered_data(62) <= 'Z';
  w_spm_filtered_data(63) <= 'Z';
  w_spm_filtered_data(64) <= 'Z';
  w_spm_filtered_data(65) <= 'Z';
  w_spm_filtered_data(66) <= 'Z';
  w_spm_filtered_data(67) <= 'Z';
  w_spm_filtered_data(68) <= 'Z';
  w_spm_filtered_data(69) <= 'Z';
  w_spm_filtered_data(70) <= 'Z';
  w_spm_filtered_data(71) <= 'Z';
  w_spm_filtered_data(72) <= 'Z';
  w_spm_filtered_data(73) <= 'Z';
  w_spm_filtered_data(74) <= 'Z';
  w_spm_filtered_data(75) <= 'Z';
  w_spm_filtered_data(76) <= 'Z';
  w_spm_filtered_data(77) <= 'Z';
  w_spm_filtered_data(78) <= 'Z';
  w_spm_filtered_data(79) <= 'Z';
  w_spm_filtered_data(80) <= 'Z';
  w_spm_filtered_data(81) <= 'Z';
  w_spm_filtered_data(82) <= 'Z';
  w_spm_filtered_data(83) <= 'Z';
  w_spm_filtered_data(84) <= 'Z';
  w_spm_filtered_data(85) <= 'Z';
  w_spm_filtered_data(86) <= 'Z';
  w_spm_filtered_data(87) <= 'Z';
  w_spm_filtered_data(88) <= 'Z';
  w_spm_filtered_data(89) <= 'Z';
  w_spm_filtered_data(90) <= 'Z';
  w_spm_filtered_data(91) <= 'Z';
  w_spm_filtered_data(92) <= 'Z';
  w_spm_filtered_data(93) <= 'Z';
  w_spm_filtered_data(94) <= 'Z';
  w_spm_filtered_data(95) <= 'Z';
  w_spm_filtered_data(96) <= 'Z';
  w_spm_filtered_data(97) <= 'Z';
  w_spm_filtered_data(98) <= 'Z';
  w_spm_filtered_data(99) <= 'Z';
  w_spm_filtered_data(100) <= 'Z';
  w_spm_filtered_data(101) <= 'Z';
  w_spm_filtered_data(102) <= 'Z';
  w_spm_filtered_data(103) <= 'Z';
  w_spm_filtered_data(104) <= 'Z';
  w_spm_filtered_data(105) <= 'Z';
  w_spm_filtered_data(106) <= 'Z';
  w_spm_filtered_data(107) <= 'Z';
  w_spm_filtered_data(108) <= 'Z';
  w_spm_filtered_data(109) <= 'Z';
  w_spm_filtered_data(110) <= 'Z';
  w_spm_filtered_data(111) <= 'Z';
  w_spm_filtered_data(112) <= 'Z';
  w_spm_filtered_data(113) <= 'Z';
  w_spm_filtered_data(114) <= 'Z';
  w_spm_filtered_data(115) <= 'Z';
  w_spm_filtered_data(116) <= 'Z';
  w_spm_filtered_data(117) <= 'Z';
  w_spm_filtered_data(118) <= 'Z';
  w_spm_filtered_data(119) <= 'Z';
  w_spm_filtered_data(120) <= 'Z';
  w_spm_filtered_data(121) <= 'Z';
  w_spm_filtered_data(122) <= 'Z';
  w_spm_filtered_data(123) <= 'Z';
  w_spm_filtered_data(124) <= 'Z';
  w_spm_filtered_data(125) <= 'Z';
  w_spm_filtered_data(126) <= 'Z';
  w_spm_filtered_data(127) <= 'Z';
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fetch_unit_v2_0
     port map (
      ...
      m01_axi_aclk => m01_axi_aclk,
      m01_axi_aresetn => m01_axi_aresetn,
      m01_axi_awaddr(26 downto 0) => \^m01_axi_awaddr\(31 downto 5),
      m01_axi_awready => m01_axi_awready,
      m01_axi_awvalid => m01_axi_awvalid,
      m01_axi_bready => m01_axi_bready,
      m01_axi_bvalid => m01_axi_bvalid,
