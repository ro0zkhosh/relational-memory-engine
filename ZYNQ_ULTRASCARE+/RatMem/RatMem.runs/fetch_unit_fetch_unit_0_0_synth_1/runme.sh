...
HD_PWD='/home/ro0zkhosh/RelMem/RelationalMem/ZYNQ_ULTRASCARE+_bkp_sep_20/RatMem/RatMem.runs/fetch_unit_fetch_unit_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fetch_unit_fetch_unit_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fetch_unit_fetch_unit_0_0.tcl
