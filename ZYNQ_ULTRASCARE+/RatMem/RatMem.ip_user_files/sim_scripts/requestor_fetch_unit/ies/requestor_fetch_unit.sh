...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.requestor_fetch_unit \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../RatMem.srcs/sources_1/bd/requestor_fetch_unit/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../RatMem.srcs/sources_1/bd/requestor_fetch_unit/ipshared/02c8/hdl/verilog" \
       +incdir+"$ref_dir/../../../../RatMem.srcs/sources_1/bd/requestor_fetch_unit/ipshared/e2dd/hdl/verilog" \
       +incdir+"../../../../RatMem.srcs/sources_1/bd/requestor_fetch_unit/ipshared/ec67/hdl" \
       +incdir+"../../../../RatMem.srcs/sources_1/bd/requestor_fetch_unit/ipshared/02c8/hdl/verilog" \
       +incdir+"../../../../RatMem.srcs/sources_1/bd/requestor_fetch_unit/ipshared/e2dd/hdl/verilog" \
