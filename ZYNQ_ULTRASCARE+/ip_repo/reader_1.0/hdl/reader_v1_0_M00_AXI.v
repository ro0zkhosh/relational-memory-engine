	...
	// Next address after ARREADY indicates previous address acceptance  
	  ...
	  begin                                                              
	    if (M_AXI_ARESETN == 0 || init_txn_pulse == 1'b1)                                          
	      ...
	      begin                                                          
	        axi_araddr <= requestor_addr + burst_size_bytes;//shahin: it was axi_araddr before instead of requestor_addr                 
	      end                                                            
	    else                                                             
...
//	            end                                                                                             
	 ...
	 // committed.                                                                                              
	  ...
	  begin                                                                                                     
	    ...
	    //else if (M_AXI_BVALID && axi_bready && (write_burst_counter == {(C_NO_BURSTS_REQ-1){1}}) && axi_wlast)
//	    else if (M_AXI_RVALID && axi_rready && (read_index == C_M_AXI_BURST_LEN-1) && (read_burst_counter[C_NO_BURSTS_REQ])) //commented by shahin
	     else if (M_AXI_RVALID && (read_index == C_M_AXI_BURST_LEN - 1) ) //commented by shahin
