...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "SUPPORTS_NARROW_BURST"
  ipgui::add_param $IPINST -name "C_S00_AXI_SUPPORTS_NARROW_BURST"
  ipgui::add_param $IPINST -name "S00_SUPPORTS_NARROW_BURST"
  ipgui::add_param $IPINST -name "S00_AXI_SUPPORTS_NARROW_BURST"

}

proc update_PARAM_VALUE.C_S00_AXI_SUPPORTS_NARROW_BURST { PARAM_VALUE.C_S00_AXI_SUPPORTS_NARROW_BURST } {
	# Procedure called to update C_S00_AXI_SUPPORTS_NARROW_BURST when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S00_AXI_SUPPORTS_NARROW_BURST { PARAM_VALUE.C_S00_AXI_SUPPORTS_NARROW_BURST } {
	# Procedure called to validate C_S00_AXI_SUPPORTS_NARROW_BURST
	return true
}

proc update_PARAM_VALUE.C_S_AXI_BITMASK_WIDTH { PARAM_VALUE.C_S_AXI_BITMASK_WIDTH } {
	# Procedure called to update C_S_AXI_BITMASK_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S_AXI_BITMASK_WIDTH { PARAM_VALUE.C_S_AXI_BITMASK_WIDTH } {
	# Procedure called to validate C_S_AXI_BITMASK_WIDTH
	return true
}

proc update_PARAM_VALUE.S00_AXI_SUPPORTS_NARROW_BURST { PARAM_VALUE.S00_AXI_SUPPORTS_NARROW_BURST } {
	# Procedure called to update S00_AXI_SUPPORTS_NARROW_BURST when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.S00_AXI_SUPPORTS_NARROW_BURST { PARAM_VALUE.S00_AXI_SUPPORTS_NARROW_BURST } {
	# Procedure called to validate S00_AXI_SUPPORTS_NARROW_BURST
	return true
}

proc update_PARAM_VALUE.S00_SUPPORTS_NARROW_BURST { PARAM_VALUE.S00_SUPPORTS_NARROW_BURST } {
	# Procedure called to update S00_SUPPORTS_NARROW_BURST when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.S00_SUPPORTS_NARROW_BURST { PARAM_VALUE.S00_SUPPORTS_NARROW_BURST } {
	# Procedure called to validate S00_SUPPORTS_NARROW_BURST
	return true
}

proc update_PARAM_VALUE.SUPPORTS_NARROW_BURST { PARAM_VALUE.SUPPORTS_NARROW_BURST } {
	# Procedure called to update SUPPORTS_NARROW_BURST when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.SUPPORTS_NARROW_BURST { PARAM_VALUE.SUPPORTS_NARROW_BURST } {
	# Procedure called to validate SUPPORTS_NARROW_BURST
	return true
}
...
proc update_MODELPARAM_VALUE.C_S_AXI_BITMASK_WIDTH { MODELPARAM_VALUE.C_S_AXI_BITMASK_WIDTH PARAM_VALUE.C_S_AXI_BITMASK_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_S_AXI_BITMASK_WIDTH}] ${MODELPARAM_VALUE.C_S_AXI_BITMASK_WIDTH}
}
