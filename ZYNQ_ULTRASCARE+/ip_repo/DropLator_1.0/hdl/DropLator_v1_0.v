...
`timescale 1 ns / 1 ps
	...
	// Wire connectin S01 to S00 to send BITMASK register data
	wire [C_S_AXI_BITMASK_WIDTH-1 : 0] ss_axi_bitmask;
	...
	) DropLator_v1_0_S00_AXI_inst (
	    //~~Shahin
	    .S_AXI_BITMASK(ss_axi_bitmask),
